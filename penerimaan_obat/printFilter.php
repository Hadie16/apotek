...
// $keyword = $_GET['keyword'];
      ...
      $query = mysqli_query($con, "SELECT a.*,b.nama_supplier nama FROM penerimaan_obat a join supplier b on a.id_supplier=b.id_supplier where DATE(a.tanggal_penerimaan_obat) BETWEEN '$startDate' AND '$endDate'");

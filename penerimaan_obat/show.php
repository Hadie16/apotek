  ...
  <div class="col">
    <div class="card shadow mb-4">
      ...
      <div class="col-sm-4">
        ...
        <a href="../penerimaan_obat/print.php" class="btn btn-sm btn-warning" target="_blank"><i class="fas fa-print"></i>
          Cetak</a>
        ...
        <div class="table-responsive mt-3" >
          <table class="table table-bordered table-hover" id="viewPenerimaanObat" style="width: 100%;">
            ...
            <tbody>
              ...
              // $query = mysqli_query($con, 'SELECT a.*,b.id_kasir,b.nama_kasir nama_kasir FROM penerimaan_obat a inner join kasir b on a.id_kasir=b.id_kasir');
            //   if (!$query) {
          ...
          $no=1;
              ...
              <td><?php echo $no++?></td>
                ...
                <td>
                  ...
                  <!-- <a class="btn text-success" href="../penerimaan_obat/print2.php?id=<?php echo $data['id_penerimaan_obat']; ?>"
                    target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Surat Pemesanan"><i class="fas fa-print"></i>
                  </a> -->
                  <a class="btn text-primary" href="?page=penerimaan_obat-detail&id=<?php echo $data['id_penerimaan_obat']; ?>"
                 data-bs-toggle="tooltip" data-bs-placement="top" title="Detail Data"><i class="fas fa-eye"></i>
                  </a>
                  <a class="btn text-info" href="?page=penerimaan_obat-edit&id=<?php echo $data['id_penerimaan_obat']; ?>"><i class="fas fa-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Data"></i></a>

                  <a class="btn text-danger" href="?page=penerimaan_obat-delete&id=<?php echo $data['id_penerimaan_obat']; ?>"
...
<div id="tableContainerTambah" style="width: 100%;">
          ...
          <table class="table table-bordered table-hover" id="viewPpenerimaanObat" style="width: 100%;">
            <thead class="bg-secondary text-white" >
            <?php

include '../connection.php';

$query = mysqli_query($con, 'SELECT a.*,b.nama_supplier nama FROM pengadaan_obat a join supplier b on a.id_supplier=b.id_supplier where status="Dipesan"');
//   if (!$query) {
//     die('Query Error: ' . mysqli_error($con));
// }
...
if ($mnr>0) {?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <a class="btn bg-info text-white" href="?page=penerimaan_obat-add&id1=<?php echo $data['id_pengadaan_obat']; ?>&id2=<?php echo $data['kode']; ?>">Pilih</a>

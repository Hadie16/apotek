...
$id = $_GET['id'];
// include '../connection.php';
$result = mysqli_query($con, "SELECT * FROM pengadaan_obat WHERE id_pengadaan_obat=$id");
...
//             window.location.href = '?page=pengadaan_obat-add';
//           </script>";
//     exit;
//   }
$update = mysqli_query($con, "UPDATE pengadaan_obat SET id_supplier='$id_supplier' WHERE id_pengadaan_obat=$id");

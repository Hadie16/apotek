...
if (isset($_POST['submit'])) {
  ...
  //pengadaan_obat
  $kode_pengadaan_obat = $_POST['kode_pengadaan_obat'];
  $tanggal_pengadaan_obat = $_POST['tanggal_pengadaan_obat'];
  // $total_harga = $_POST['harga'];
  $id_supplier = $_POST['id_supplier'];
  // $id_kasir = '2';

$jenis_produk_array = $_POST['id_obat'];
 $jenis_produk = count($jenis_produk_array); 

  $insert = mysqli_query($con, "INSERT INTO pengadaan_obat(kode,jenis_produk,tanggal,id_supplier,status) 
...
for ($i = 0; $i < count($id_obat_array); $i++) {
  ...
  $insert_query = "INSERT INTO detail_pengadaan_obat (id_pengadaan_obat,id_obat,jumlah,satuan) VALUES ('$firstTableID','$id_obat','$jumlah','$satuan')";
  ...
  <div class="col">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-info">Pengadaan Obat</h6>
...
<?php
    ...
    $query = mysqli_query($con, "SELECT kode FROM pengadaan_obat ORDER BY kode DESC LIMIT 1");
    ...
    $KodeNumber = 'PGD-' . $year . '-' . str_pad($newKodeNumber, 4, '0', STR_PAD_LEFT);

    ?>
    <div class="col-sm-5 offset-sm-2">
            <label for="nim" class="col-sm-2 col-form-label">Kode</label>
            <input type="text" name="kode_pengadaan_obat" required="required" class="form-control" value="<?php echo $KodeNumber ?>" readonly>
            <!-- <div class="col-sm-5"> -->
            ...
            <!-- <div class="col-sm-5"> -->
              ...
              <input type="text" class="form-control" name="tanggal_pengadaan_obat" value="<?php echo date('Y-m-d'); ?>" >
          ...
          <div class="row">
            ...
            <div align="center" class="col">
              <button type="submit" class="btn btn-primary" name="submit"><i class="fas fa-save"></i>
                Simpan</button>
              <a href="?page=pengadaan_obat-show" class="btn btn-danger"><i class="fas fa-chevron-left"></i>
                Kembali</a>
            </div>

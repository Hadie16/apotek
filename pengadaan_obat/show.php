  ...
  <div class="col">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <h6 class="m-0 font-weight-bold text-info">Pengadaan Obat - Pemesanan</h6>
            ...
            <tbody>
              ...
              <td><?php echo $data['kode']; ?></td>
                ...
                <!-- <a class="btn text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Konfirmasi Pesanan"><i class="fas fa-check"></i></a> -->
                  ...
                  <a class="btn text-warning" href="../pengadaan_obat/print2.php?id=<?php echo $data['id_pengadaan_obat']; ?>"
                    target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Surat Pemesanan"><i class="fas fa-print"></i>
                  </a>
                  <a class="btn text-primary" href="?page=pengadaan_obat-detail&id=<?php echo $data['id_pengadaan_obat']; ?>"
                 data-bs-toggle="tooltip" data-bs-placement="top" title="Detail Data"><i class="fas fa-eye"></i>
                  </a>
                  <a class="btn text-info" href="?page=pengadaan_obat-edit&id=<?php echo $data['id_pengadaan_obat']; ?>"><i
...
<div class="row">
  <div class="col">
    <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-info">Pengadaan Obat - Diterima</h6>
      ...
      <div class="col-sm-4">
        ...
        <!-- <a href="../ketersediaan_obat/print.php" class="btn btn-sm btn-info" target="_blank"><i class="fas fa-print"></i>
          Cetak
          FPDF</a> -->
        <a href="../pengadaan_obat/print.php" class="btn btn-sm btn-warning" target="_blank"><i class="fas fa-print"></i>
          Cetak</a>
          ...
          <div class="row">   
            ...
            <!-- <label for="harga_jual_obat" class="col-form-label">From</label> -->
               ...
               <input type="hidden" data-page="PGD" >
  </div>
...
$no = 1;
      ...
      <td><?php echo $no++ ?></td>
                ...
                <td align="center">
                  <!-- <a class="btn bg-info text-white" href="?page=pengadaan_obat-detail&id=<?php echo $data['id_pengadaan_obat']; ?>">Detail
                  </a> -->
                  <a class="btn text-warning" href="../pengadaan_obat/print2.php?id=<?php echo $data['id_pengadaan_obat']; ?>"
                    target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Surat Pemesanan"><i class="fas fa-print"></i>
                  </a>

...
?>
<br>
<h2 align="center">Laporan Data Pengadaan Obat ( <?php echo $showDate ?>  )</h2>
...
// $keyword = $_GET['keyword'];
      ...
      $query = mysqli_query($con, "SELECT *,b.nama_supplier suppliers FROM pengadaan_obat a join supplier b on a.id_supplier=b.id_supplier join detail_pengadaan_obat dpo on a.id_pengadaan_obat=dpo.id_pengadaan_obat join obat o on dpo.id_obat=o.id_obat where status='Diterima' and DATE(a.tanggal) BETWEEN '$startDate' AND '$endDate'");
    if ($query) {

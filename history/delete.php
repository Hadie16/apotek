...
$id = $_GET['id'];
$result = mysqli_query($con, "DELETE FROM pasien WHERE pasien=$id");

$result = mysqli_query($con, "DELETE FROM cek_kesehatan WHERE id_pasien=$id");
...
echo "<meta http-equiv='refresh' content='0; url=?page=history-show'>";
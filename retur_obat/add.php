...
if (isset($_POST['submit'])) {
  ...
  $insert = mysqli_query($con, "INSERT INTO retur_obat(kode_retur_obat,id_supplier,tanggal_retur,no_faktur,status) 
  VALUES('$kode_retur_obat','$id_supplier','$tanggal_retur_obat','$no_faktur','Proses')");
  if (!$insert) {
  ...
  //    $hargaKet= $hargaKet_array[$i];
    ...
    $insert_query = "INSERT INTO detail_retur_obat (id_retur_obat,id_obat, jumlah,satuan,batch_number,tanggal_kadaluarsa,value) 
                   VALUES (' $firstTableID','$id_detailPO','$jumlah','$satuan','$batch_number','$tanggal_exp','$harga_beli_obat')";
...
<div class="row">
  <div class="col">
    ...
    $KodeNumber = 'RET-' . $year . '-' . str_pad($newKodeNumber, 4, '0', STR_PAD_LEFT);
          ?>
              <input type="text" name="kode_retur_obat" required="required" class="form-control" value="<?php echo $KodeNumber?>" readonly>
              ...
              <input type="text" class="form-control" name="tanggal_retur_obat" value="<?php echo date('Y-m-d'); ?>" readonly>
              ...
              <!-- <form method="POST"> -->
                ...
                <select  name="id_supplier" id="" class="form-control" required>
                      ...
                      while ($row = mysqli_fetch_assoc($query)) {
                        ...
                        // $idd = 2;
                        echo '<option value="' . $id_obat1 . '" >' . $nama . '</option>';
                      }
                ...
                <select  name="no_faktur" id="" class="form-control" required>
                      ...
                      $query = mysqli_query($con, "SELECT no_faktur FROM penerimaan_obat");
        
                      while ($row = mysqli_fetch_assoc($query)) {
                        // $id_obat1 = $row['no_faktur'];
                        // $id_D = $row['id_ketersediaan_obat'];
                        $nama = $row['no_faktur'];
              ...
              <tbody>
                <tr>
                  ...
                  <td width="15%">
                    ...
                    <input type="hidden" class="id_obatt" name="id_obatt[]"  id="id_obatt">
                      <input type="hidden" class="id_ketersediaan_obat" name="id_ketersediaan_obat[]" id="id_ketetersediaan_obat">
    ...
    <!-- <p align="center" class="stock-left jumlah_stok_obat" >kk</p>                         -->
                  ...
                  <td width="9%"><input type="number" required="required" class="form-control qty-inputs jumlah" name="jumlah[]" placeholder="Qty">
                    ...
                    <input type="hidden" class="form-control harga_beli_obat" name="harga_beli_obat[]">
                  ...
                  <td width="10%"><input type="text" class="form-control unit-price-input satuan" id="satuan" name="satuan[]" placeholder="Satuan" readonly required> 
                  <p class="text-center mb-0">-</p>
                  <input type="text" class="form-control satuan border-0 text-secondary" name="jumlah_stok_sisa[]" readonly>

...
<div class="row">
        ...
        <div class="table-responsive mt-3" >
          <table class="table table-bordered table-hover display" id="salesTable" style="width: 100%;">
            ...
            <tbody>
              ...
              $query = mysqli_query($con, 'SELECT a.*,c.nama_supplier suppliers,b.*,d.nama_obat FROM retur_obat a join supplier c on a.id_supplier=c.id_supplier join detail_retur_obat b on a.id_retur_obat=b.id_retur_obat join obat d on b.id_obat=d.id_obat');
              $no=1;
 ...
 <td><?php echo $data['batch_number']; ?></td>
                ...
                <td>
                <a class="btn text-success" href="../retur_obat/ttrb.php?id=<?php echo $data['id_retur_obat']; ?>"
                    target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Print Data"><i class="fas fa-print"></i>
                  </a>
                  <!-- link detail -->
                <!-- href="?page=retur_obat-detail&id=<?php echo $data['id_retur_obat']; ?>" -->

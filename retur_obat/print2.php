...
if (mysqli_connect_errno()) {
    die("Failed to connect to MySQL: " . mysqli_connect_error());
      ...
      $query = mysqli_query($con, 'SELECT a.*,b.nama_obat as obats,c.nama_supplier as suppliers,d.* FROM retur_obat a join detail_retur_obat d on a.id_retur_obat=d.id_retur_obat join obat b on d.id_obat=b.id_obat join supplier c on a.id_supplier=c.id_supplier');

    ...
    <div class="card shadow mb-4">
      ...
      <a href="../stok_obat/printExp.php" class="btn btn-sm btn-warning" target="_blank"><i class="fas fa-print"></i>
        ...
        <div class="table-responsive mt-3" >
          <table class="table table-bordered table-hover" id="viewExpired" style="width: 100%;">
          ...
          FROM stok_obat a
          JOIN obat c ON a.id_obat = c.id_obat where tanggal_kadaluarsa_obat < CURDATE() and a.jumlah_stok_obat > 0");
...
<div class="row">
  ...
  <button id="filterButtonPGD" class="btn btn-warning" ><i class="fas fa-print"></i></button>
        ...
        <hr>
        <div class="table-responsive mt-3" >
          <table class="table table-bordered table-hover" id="viewExpiredALK" style="width: 100%;">
          <thead class="bg-secondary text-white" >
              <!-- <thead> -->
              <tr align="center">
              <th >No</th>
          ...
          FROM stok_alkes a
          JOIN alkes c ON a.id_alkes = c.id_alkes where tanggal_kadaluarsa_alkes < CURDATE() and a.jumlah_stok_alkes > 0");

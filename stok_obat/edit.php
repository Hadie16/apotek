...
if (isset($_POST['submit'])) {
  ...
  $update = mysqli_query($con, "UPDATE stok_obat SET 
  jumlah_stok_obat = '$jumlah_stok_obat',
  satuan = '$satuan',
  harga_jual_obat = '$harga_jual_obat',
  tanggal_kadaluarsa_obat = '$tanggal_kadaluarsa_obat'
WHERE id_stok_obat = '$id'");
...
<input type="hidden" class="form-control" id="id_obats" name="id_obat" required>  
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <input type="number" class="form-control" id="jumlah_stok_obat" name="jumlah_stok_obat" oninput="calculateAndUpdate()"  value="<?php echo $jumlah_stok_obat?>" required>  
            </div>

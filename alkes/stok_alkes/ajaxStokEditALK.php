  ...
  var jso = $('#jumlah_stok_alkes').val();
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.status === 'success') {
            ...
            var jumlah_ket = parseInt(response.data.jumlah_ketersediaan_alkes) + parseInt(jso);

            $('#jumlah_ketersediaan_alkes').val(jumlah_ket);
      ...
      var jumlah = parseInt($('#jumlah_ketersediaan_alkes').val());
        ...
        if (isNaN(jumlah_ketersediaan_alkes)) {
          ...
          jumlah_ketersediaan_alkes = jumlah_ket;

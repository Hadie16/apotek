  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.status === 'success') {
        ...
        currentRow.find('.jumlah_stok_sisa_hitung').val(response.data.jumlah_ketersediaan_alkes);
        currentRow.find('.jumlah_stok_sisa').val(response.data.jumlah_ketersediaan_alkes);

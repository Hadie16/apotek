...
<p style="margin-left: 35px;">No. <?php echo $kodes?></p>
  <br>
<p style="margin-left: 35px;">Dengan ini kami mengembalikan alat kesehatan, sebagai berikut :</p>
...
<div align="center" style="position: relative; top: 50px; left: 500px;">
  <p>Martapura,
     <?php
          $query1 = mysqli_query($con, "SELECT tanggal_retur from retur_alkes where id_retur_alkes='$id'");
          if ($query1) {
            // echo "<p>query berhasil<p/>";
        } else {
            die('invalid Query : ' . mysqli_error($con));

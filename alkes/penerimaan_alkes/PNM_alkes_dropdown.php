...
//  var grandTotal = gt.toLocaleString('id-ID');
    ...
    $('#myTablePNMS tbody tr').each(function() {
  ...
  // $('.qty-input, .unit-price-input').on('input', function() {
    $('#myTablePNMS').on('input', '.qty-inputs, .unit-price-inputs', function() {
...
$('#addRowBtnPNMS').click(function() {
  rowCount++;

  // Clone the last row
  const newRow = $('#myTablePNMS tbody tr:last').clone();
  ...
  $('#myTablePNMS tbody').append(newRow);

});

// Delete row button click event
$(document).on('click', '.delete-rowPNMS', function() {
...
$(document).on('change', '.select-optionALK', function() {
...
// response.data.satuan)
  ...
  //  $('#myTablePNMS').on('input', '.jumlah', function() 

  // {

    // var dd = currentRow.find('#result_id_alkes').val();

    //   var dd = currentRow.find('.satuan').val();
      // var jj =  currentRow.find('.jumlah').val();

    //   var jumlah_stok_alkes = dd - jj;
...
if (stn == "Box") {
  ...
  $('#myTablePNMS').on('input','.unit-price-inputs', '.boxjumlah', function() {
...
function updateRowNumbers() {
  $('#myTablePNMS tbody tr').each(function(index) {
...
// // var selectedOption = $('#id_alkes_select_edit').val();
// // var jso = $('#jumlah_stok_alkes').val();
// //    })
